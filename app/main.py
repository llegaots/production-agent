...
async def health() -> dict:
    return {
        ...
        "model_raw": getattr(llm, "model_raw", None) if llm.enabled else None,
        "model_source": getattr(llm, "model_source", None) if llm.enabled else None,
        "env_file": str(ENV_PATH) if ENV_PATH.exists() else None,
        "cursor_handoff_model": cursor_cloud.model,
...
async def get_config() -> dict:
    ...
    return {
        ...
        "llm_model_raw": getattr(llm, "model_raw", None) if llm.enabled else None,
